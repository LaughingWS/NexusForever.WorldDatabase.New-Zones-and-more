...
-- --------------------------------------------------------------------------------------------------------------------
-- TODO: Get QuestChecklistIdx?. Place X, Y, Z, RX
-- -------------------------------------------------
SET @WORLD = 1221;
DELETE FROM `entity` WHERE `world` = @WORLD AND `area` IN (0, 1130, 1133, 1134, 1144, 1161, 1162, 1163, 1164, 1165, 1194, 1195, 1196, 1197, 1198, 1199, 1200, 1201, 1202, 1203, 1204, 1205, 1206, 1207, 1208, 1209, 1210, 1563, 1564, 1565, 1566, 1567);
-- --------------------------------------
...
(@GUID+1, 0, 1);
-- --------------------------------------
-- I have 184 coordinates for this.
-- --------------------------------------