...
-- Dumping structure for table mnexus_forever_world.store_category
...
-- Dumping data for table mnexus_forever_world.store_category: ~0 rows (approximately)
...
-- Dumping structure for table mnexus_forever_world.store_offer_group
DROP TABLE IF EXISTS `store_offer_group`;
...
-- Dumping data for table mnexus_forever_world.store_offer_group: ~315 rows (approximately)
...
-- Dumping structure for table mnexus_forever_world.store_offer_group_category
DROP TABLE IF EXISTS `store_offer_group_category`;
...
-- Dumping data for table mnexus_forever_world.store_offer_group_category: ~652 rows (approximately)
...
-- Dumping structure for table mnexus_forever_world.store_offer_item
DROP TABLE IF EXISTS `store_offer_item`;
...
-- Dumping data for table mnexus_forever_world.store_offer_item: ~439 rows (approximately)
...
-- Dumping structure for table mnexus_forever_world.store_offer_item_data
DROP TABLE IF EXISTS `store_offer_item_data`;
...
-- Dumping data for table mnexus_forever_world.store_offer_item_data: ~1,117 rows (approximately)
...
-- Dumping structure for table mnexus_forever_world.store_offer_item_price
DROP TABLE IF EXISTS `store_offer_item_price`;
...
-- Dumping data for table mnexus_forever_world.store_offer_item_price: ~875 rows (approximately)
