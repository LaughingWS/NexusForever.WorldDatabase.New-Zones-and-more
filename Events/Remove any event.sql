...
-- Dungeon Chase
-- --------------------------------------
DELETE FROM `entity` WHERE `world` = 51 AND `Creature` IN (71788, 73686, 73687, 73688, 73689);
...
-- Sim Chase
-- --------------------------------------
DELETE FROM `entity` WHERE `world` = 51 AND `Creature` IN (71788, 73337, 73338, 73339, 73340);
DELETE FROM `entity` WHERE `world` = 22 AND `Creature` IN (73337, 73338, 73339, 73340);
DELETE FROM `entity` WHERE `world` = 22 AND `area` = 2193 AND `Creature` IN (71788);
-- --------------------------------------
-- Space Chase
-- --------------------------------------
DELETE FROM `entity` WHERE `world` = 51 AND `Creature` IN (71788, 73165, 73166, 73211, 73212);
...
DELETE FROM `entity` WHERE `world` = 22 AND `Creature` IN (71683, 71689, 71695, 71735, 71736, 71737, 71786, 71788, 71804, 71805, 71806, 71807, 71866, 71867, 71868, 71869, 71870, 71871, 71907, 71910, 71911, 71985, 72039, 72041, 72043, 72045, 72047, 72050, 72051, 72052, 72053, 72054, 72181, 74814, 74816, 74817);
DELETE FROM `entity` WHERE `world` = 22 AND `area` = 2193 AND `Creature` IN (71788);
-- --------------------------------------
-- Shade's Eve (WIP)
-- --------------------------------------
