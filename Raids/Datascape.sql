...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 31677, @WORLD, 4475, 3356.48, -765.57, -3246.29, 1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1);
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 56200, @WORLD, 4476, 3635.073, -745.20, -3373.29, 1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1);
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 31674, @WORLD, 4476, 3328.50, -696.86, -3639.44, 1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1);
...
(@GUID+4, 0, 31676, @WORLD, 4475, 3485.37, -745.42,  3298.51, 0, 0,                                               0, 1,  1071, 1071),
(@GUID+5, 0, 31676, @WORLD, 4475, 3554.53, -741.13, -3433.60, 0, 0,                                               0, 1,  1071, 1071),
(@GUID+6, 0, 31676, @WORLD, 4475, 3580.04, -741.21, -3426.10, 0, 0,                                               0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1),
...
(@GUID+8,  0, 31678, @WORLD, 4476, 3523.36, -719.01, -3604.54,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+9,  0, 31678, @WORLD, 4476, 3535.42, -718.95, -3593.21,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+10, 0, 31678, @WORLD, 4476, 3548.71, -718.72, -3594.02,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+11, 0, 31678, @WORLD, 4476, 3566.64, -719.71, -3601.15,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+12, 0, 31678, @WORLD, 4476, 3562.48, -720.02, -3614.30,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+13, 0, 31678, @WORLD, 4476, 3548.33, -718.88, -3611.51,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+14, 0, 31678, @WORLD, 4476, 3548.35, -718.92, -3600.83,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+15, 0, 31678, @WORLD, 4476, 3558.34, -718.80, -3604.18,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+16, 0, 31678, @WORLD, 4476, 3469.08, -719.72, -3693.57,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+17, 0, 31678, @WORLD, 4476, 3461.45, -720.17, -3672.40,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+18, 0, 31678, @WORLD, 4476, 3452.34, -720.19, -3675.38,  1, 0,                                                0, 1,  1071, 1071),
(@GUID+19, 0, 31678, @WORLD, 4476, 3452.37, -720.40, -3666.58,  1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1,  10,      50),
(@GUID+1,  0,  1300000),
(@GUID+1,  20,       1),
...
(@GUID+19, 20,       1);
-- --------------------------------- ---
-- Grizzled Tundra Packmember (GRN)(LAF) not used (maybe this was deleted)
-- --------------------------------- ---
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
...
(@GUID+4, 20,  1);
-- ---------------------------------
-- Ice Dracus (GRN) (LAF) is this the big slime thing?
-- ---------------------------------
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 48364, @WORLD, 1592, 3595.03, -746.70,  3374.76, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+2, 0, 48364, @WORLD, 4476, 3590.13, -722.72, -3630.31, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+3, 0, 48364, @WORLD, 4476, 3500.44, -722.46, -3628.07, 1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1),
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1,  0, 45805, @WORLD, 1592, 3223,    -766,    -3322.83, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+2,  0, 45805, @WORLD, 1592, 3202,    -769,    -3350.22, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+3,  0, 45805, @WORLD, 1592, 3219.25, -766.58, -3340,    1, 0,                                                0, 1,  1071, 1071),
(@GUID+4,  0, 45805, @WORLD, 4475, 3351.94, -766.58, -3325.50, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+5,  0, 45805, @WORLD, 4475, 3329.05, -765.32, -3320.44, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+6,  0, 45805, @WORLD, 4475, 3347,    -766.76, -3313.29, 1, 0,                                                0, 1,  1071, 1071),
...
(@GUID+9,  0, 48365, @WORLD, 4475, 3534.09, -742.50, -3377.51, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+10, 0, 48365, @WORLD, 4475, 3570.17, -743.55, -3310.54, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+11, 0, 48365, @WORLD, 4475, 3561.36, -743.80, -3310.41, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+12, 0, 48365, @WORLD, 4475, 3556.99, -746.70, -3343.99, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+13, 0, 48365, @WORLD, 4475, 3567.98, -746.70, -3370.00, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+14, 0, 48365, @WORLD, 4475, 3580.56, -742.84, -3411.82, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+15, 0, 48365, @WORLD, 4475, 3574.55, -742.83, -3408.81, 1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10,  50),
(@GUID+1, 0,    1),
(@GUID+1, 20,   1),
...
(@GUID+3, 0, 48366, @WORLD, 4476, 3661.88, -721.67, -3574.28, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+4, 0, 48366, @WORLD, 4476, 3614.53, -722.51, -3569.31, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+5, 0, 48366, @WORLD, 4476, 3456.78, -720.19, -3672.20, 1, 0,                                                0, 1,  1071, 1071),
(@GUID+6, 0, 48366, @WORLD, 4476, 3502.88, -719.88, -3716.25, 1, 0,                                                0, 1,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1),
