...
(@GUID+2, 0, 48167, @WORLD,  1301,    343.1044,    -226.54833,   -246.62102,    0.53113, 0, 0, 27811,  1071, 1071),
(@GUID+3, 0, 48167, @WORLD,  1301,    342.20944,   -226.54833,   -107.46735,    1.76798, 0, 0, 27811,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0, 3000000),
(@GUID+2, 10, 50),
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 31677, @WORLD, 4475, 3356.48, -765.57, -3246.29, 1, 0,                                                0, 27434,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10,        50),
(@GUID+1, 0,   14500000);
-- ---------------------------------
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 56200, @WORLD, 4476, 3635.073, -745.20, -3373.29, 1, 0,                                                0, 27434,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10,        50),
(@GUID+1, 0,   14500000);
-- ---------------------------------
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 31674, @WORLD, 4476, 3328.50, -696.86, -3639.44, 1, 0,                                                0, 23490,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1);
-- ---------------------------------
-- Spinecleaver Walatusk (LAF)
-- ---------------------------------
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
...
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 48363, @WORLD, 1592, 3243.62, -764.53, -3352.2,  1, 0,                                                0, 22313,  1071, 1071),
(@GUID+2, 0, 48363, @WORLD, 1592, 3228,    -764.82, -3380.62, 1, 0,                                                0, 22313,  1071, 1071),
(@GUID+3, 0, 48363, @WORLD, 4475, 3368.35, -766.2,  -3304.13, 1, 0,                                                0, 22313,  1071, 1071),
(@GUID+4, 0, 48363, @WORLD, 4475, 3328.77, -767.83, -3293.98, 1, 0,                                                0, 22313,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1),
...
(@GUID+4, 20,  1);
-- ---------------------------------
-- Semi-Colloidal Consumption Entity (LAF)
-- ---------------------------------
SET @GUID = (SELECT IFNULL(MAX(`id`), 0) FROM `entity`);
INSERT INTO `entity` (`Id`, `Type`, `Creature`, `World`, `Area`, `X`, `Y`, `Z`, `RX`, `RY`, `RZ`, `DisplayInfo`,  `Faction1`, `Faction2`) VALUES
(@GUID+1, 0, 48364, @WORLD, 1592, 3595.03, -746.70, -3374.76, 1, 0,                                                0, 27981,  1071, 1071),
(@GUID+2, 0, 48364, @WORLD, 4476, 3590.13, -722.72, -3630.31, 1, 0,                                                0, 27981,  1071, 1071),
(@GUID+3, 0, 48364, @WORLD, 4476, 3500.44, -722.46, -3628.07, 1, 0,                                                0, 27981,  1071, 1071);
INSERT INTO `entity_stats` (`Id`, `Stat`, `Value`) VALUES
(@GUID+1, 10, 50),
(@GUID+1, 0,   1),
(@GUID+1, 20,  1),
...
(@GUID+3,  0, 48365, @WORLD, 1592, 3219.25, -766.58, -3340,    1, 0,                                                0, 22385,  1071, 1071),
(@GUID+4,  0, 48365, @WORLD, 4475, 3351.94, -766.58, -3325.50, 1, 0,                                                0, 22385,  1071, 1071),
(@GUID+5,  0, 48365, @WORLD, 4475, 3329.05, -765.32, -3320.44, 1, 0,                                                0, 22385,  1071, 1071),
(@GUID+6,  0, 48365, @WORLD, 4475, 3347,    -766.76, -3313.29, 1, 0,                                                0, 22385,  1071, 1071),
...
(@GUID+3, 0, 48366, @WORLD, 4476, 3661.88, -721.67, -3574.28, 1, 0,                                                0, 24111,  1071, 1071),
(@GUID+4, 0, 48366, @WORLD, 4476, 3614.53, -722.51, -3569.31, 1, 0,                                                0, 24111,  1071, 1071),
(@GUID+5, 0, 48366, @WORLD, 4476, 3456.78, -720.19, -3672.20, 1, 0,                                                0, 24111,  1071, 1071),
